...
#Install Software
sudo apt install -y net-tools python3-pygments nfs-common nfs-kernel-server python3 apt-transport-https ca-certificates curl gnupg lsb-release nodejs npm wget remmina ktorrent git chromium wireshark default-jdk nmap clusterssh timeshift ibus-unikey plank qt5-style-kvantum flameshot
