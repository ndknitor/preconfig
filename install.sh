...
#Install Software
sudo apt install -y net-tools python3 apt-transport-https ca-certificates curl gnupg lsb-release nodejs wget remmina ktorrent git chromium wireshark default-jdk nmap clusterssh timeshift ibus-unikey latte-dock qt5-style-kvantum
